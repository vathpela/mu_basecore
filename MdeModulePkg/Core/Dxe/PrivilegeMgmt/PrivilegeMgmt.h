...
#define LONG_DS_R0_PH                   0x40
#define LONG_DS_R3                      0x4B
#define LONG_CS_R3                      0x53
#define CALL_GATE_OFFSET                0x58
#define TSS_SEL_OFFSET                  0x68
#define TSS_DESC_OFFSET                 0x78
...
extern VOID* mDxeCpl3StackArrayBase;
extern UINTN mDxeStackSize;
...
InvokeDemotedDriverEntryPoint (
  IN EFI_IMAGE_ENTRY_POINT    EntryPoint,
